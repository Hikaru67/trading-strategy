#!/usr/bin/env python3
"""
Analyze All Strategies with Fixed Parameters
"""
...
def get_all_strategies():
    ...
    strategies = [
        ...
        # Advanced strategies  
        'vsa_obv', 'multi_indicator', 'ema_rsi_ichimoku', 'enhanced_with_candlestick',
        # Divergence strategies
        'divergence_strategy', 'simple_divergence_strategy',
        # Wyckoff strategies
        'wyckoff_vsa', 'practical_wyckoff_vsa',
        # Smart TP strategies
        'smart_tp_strategy', 'adaptive_tp_strategy',
        # SMC strategies
        'smc_strategy', 'breaker_block_strategy',
        # Ultra simple
        'ultra_simple_strategy'
    ]
    return strategies

def analyze_all_strategies(symbol='SUIUSDT', start_date='2025-01-01', end_date='2025-08-22',
                          initial_balance=1000, reward_ratio=1.0, is_reverse=True,
                          no_fees=True, trailing_ratio=0, enable_scaling=True, 
                          scaling_multiplier=1.0, timeframes=['5m', '15m', '30m', '1h', '4h']):
    """
    Analyze all strategies with fixed parameters
    """
    ...
    report_filename = f"{reports_dir}/strategy_analysis_{symbol}_{timestamp}.md"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Analyze all strategies with fixed parameters')
